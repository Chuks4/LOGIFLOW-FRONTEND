...
} from "@/services/axios/analytics.service";
import {
  getShipments,
  type Shipment,
  ...
  return (
    <section className={styles.dashboard}>
      <div className={styles.welcome}>
        <p className={styles.kicker}>Customer overview</p>
        <h2>Your operations at a glance.</h2>
        <p>Track shipments you have created and their delivery progress.</p>
      </div>
      ...
      <div className={styles.shipments}>
        <div className={styles.shipmentsHeader}>
          <p className={styles.kicker}>Shipment history</p>
          <h3>All your shipments</h3>
        </div>
        <DashboardShipmentsTable
          ...
          page={page}
          searchPlaceholder="Search by tracking number or recipient"
          searchValue={keyword}
          shipments={shipments}
